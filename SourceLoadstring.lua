...
function RewindKrypton()
  if _G.RewindKrypton == "a3.3" then
    warn("No need to rewind Krypton is alreadly using the latest version!")
...
if not _G.License then
  ...
  warn("Krypton Version: " .. LatestKryptonVersion)
end

function KryptonBoot()
	if not _G.RewindKrypton and _G.RewindKrypton then
