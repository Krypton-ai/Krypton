...
local Window = OrionLib:MakeWindow({
	...
	IntroEnabled = true,
	IntroText = "Krypton",
	IntroIcon = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNlA28XsmSHB-VYAUdVuHFaLRVLi_A5nC6lw&usqp=CAU",
	SaveConfig = true,
...
local SelectedPlayerLabel = InfoTab:AddLabel("Label")
...
local PlayerDropdown = InfoTab:AddDropdown({
    ...
    Callback = function(Selected)
        local SelectedPlayerLabel = InfoTab:AddLabel(Selected)
