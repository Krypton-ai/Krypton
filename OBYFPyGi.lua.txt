...
local function fetchAndParse(url)
    ...
    if success then
        ...
        parsedKey = parsedResponse.key or "No key provided"
...
MiscTab:AddButton({
    ...
    Callback = function()
        ...
        finalObfuscatedCode = string.format('__Krypton__ = \'Obfuscated by usingKrypton\'\nloadstring("%s")()', obfuscatedBytecode)
